...
public class JdbcPostRepository implements PostRepository{
    ...
    public Post insert(Post post) {
        ...
        jdbcTemplate.update(conn -> {
            PreparedStatement ps = conn.prepareStatement("INSERT INTO posts(seq,user_seq,contents,like_count,comment_count,create_at,title) VALUES (null,?,?,?,?,?,?)", new String[]{"seq"});
    ...
    public void update(Post post) {
        jdbcTemplate.update(
                "UPDATE posts SET contents=?,like_count=?,comment_count=?,title=? WHERE seq=?",
                post.getContents(),
                post.getLikes(),
                post.getComments(),
                post.getTitle(),
